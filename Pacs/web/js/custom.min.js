...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        var g = {
				...
				colors: ["rgb(99,160,212)", "rgb(183,51,56)"],
                xaxis: {
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                labels: ["Not Available", "Need Attention", "At Risk", "Complete"],
                datasets: [{
                    data: [15, 20, 30, 10],
                    backgroundColor: ["#BDC3C7", "#FFC200", "#E74C3C", "#26B99A"],
                    hoverBackgroundColor: ["#CFD4D8", "#dac923", "#E95E4F", "#36CAAB"]
                }]
            },
            options: {
                legend: !1,
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (c.maxValue = 0, c.animationSpeed = 32, c.set(0), c.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) var d = document.getElementById("chart_gauge_02"),
            e = new Gauge(d).setOptions(a);
        $("#gauge-text2").length && (e.maxValue = 100, e.animationSpeed = 32, e.set(100), e.setTextField(document.getElementById("gauge-text2")))
    }
}
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#canvasDoughnut").length) {
            var f = document.getElementById("canvasDoughnut"),
                i = {
                    labels: ["Grey", "Yellow", "Red", "Green"],
                    datasets: [{
                        data: [120, 50, 140, 180],
                        backgroundColor: ["#BDC3C7", "#e6d740", "#E74C3C", "#26B99A"],
                        hoverBackgroundColor: ["#34495E", "#dac923", "#CFD4D8", "#36CAAB"]
                    }]
                };
            new Chart(f, {
                type: "doughnut",
        ...
        if ($("#pieChart").length) {
            var f = document.getElementById("pieChart"),
                i = {
                    datasets: [{
                        data: [120, 80, 75, 100,150,150],
                        backgroundColor: ["#138ada", "#72a6ca", "#6bc4ff", "#3498DB","#006ab3","#abddff"],
                        label: "My dataset"
                    }],
                    labels: ["Dark Gray", "Gray", "Green", "Blue"]
                };
            new Chart(f, {
                data: i,
                type: "pie",
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
		...
		var colorDash= ["#BDC3C7", "#fec100", "#E74C3C", "#26B99A"];
		if($("body").attr("id") == "funding-dahsboard")
		{
			 var colorDash= ["#138ada", "#72a6ca", "#6bc4ff", "#3498DB","#006ab3","#abddff"];				 
		}		
		else
		{
		   var colorDash= ["#BDC3C7", "#fec100", "#E74C3C", "#26B99A"];
        ...
        if ($("#echart_donut").length) {
            ...
            i.setOption({
                ...
                legend: {
                    x: "center",
                    y: "top",
                    data: ["Not Available", "Complete", "At Risk", "Need Attention"]					
                },				
                /*toolbox: {
                    show: !0,
                    feature: {
        ...
        if ($("#echart_pie").length) {
            ...
            j.setOption({
                ...
                legend: {
                    x: "center",
                    y: "bottom",
                    data: ["By next reporting period", "Complete", "Non Compliant count", "In 90 days from this report"]
                },
                /*toolbox: {
                    show: !0,
                    feature: {
